...
type ReportItem = Omit<(typeof availableReports)[0], "id"> & {
  id: number | string;
  isLive?: boolean;
  rawData?: any;
};

// e.g. "20 Sep 2026, 9:45 pm" - the time tells same-day reports apart
const formatReportDate = (value?: string | Date | null) =>
  new Date(value ?? Date.now()).toLocaleString("en-AU", {
    day: "numeric",
    month: "short",
    year: "numeric",
    hour: "numeric",
...
Reference: ${String(data.job_id).slice(0, 8)}
`;
};
  ...
  useEffect(() => {
    ...
    fetch(`${BACKEND_URL}/api/analytics/latest`, {
      ...
      .then((data) => {
        ...
        setLiveReport({
          id: `live-${data.job_id}`,
          name: `Video Analysis — ${formatReportDate(created)}`,
